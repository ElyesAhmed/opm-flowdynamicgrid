 ...
 */
#ifndef EWOMS_BLACK_OIL_INTENSIVE_QUANTITIES_DYNANIC_HH
#define EWOMS_BLACK_OIL_INTENSIVE_QUANTITIES_DYNAMIC_HH
...
class BlackOilIntensiveQuantitiesDynamic
...
public:
    ...
    BlackOilIntensiveQuantitiesDynamic()
    {
    ...
    BlackOilIntensiveQuantitiesDynamic(const BlackOilIntensiveQuantitiesDynamic& other) = default;

    BlackOilIntensiveQuantitiesDynamic& operator=(const BlackOilIntensiveQuantitiesDynamic& other) = default;
